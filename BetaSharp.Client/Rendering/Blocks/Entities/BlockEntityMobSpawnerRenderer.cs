...
public class BlockEntityMobSpawnerRenderer : BlockEntitySpecialRenderer
{
    ...
    public void renderTileEntityMobSpawner(BlockEntityMobSpawner var1, double var2, double var4, double var6, float var8)
    {
        ...
        RenderDragon.Api.Translate((float)var2 + 0.5F, (float)var4, (float)var6 + 0.5F);
        ...
        if (var9 != null)
        {
            ...
            RenderDragon.Api.Translate(0.0F, 0.4F, 0.0F);
            RenderDragon.Api.Rotate((float)(var1.LastRotation + (var1.Rotation - var1.LastRotation) * (double)var8) * 10.0F, 0.0F, 1.0F, 0.0F);
            RenderDragon.Api.Rotate(-30.0F, 1.0F, 0.0F, 0.0F);
            RenderDragon.Api.Translate(0.0F, -0.4F, 0.0F);
