...
public class SquidEntityRenderer : LivingEntityRenderer
{
    ...
    protected void func_21007_a(EntitySquid var1, float var2, float var3, float var4)
    {
        ...
        RenderDragon.Api.Translate(0.0F, 0.5F, 0.0F);
        RenderDragon.Api.Rotate(180.0F - var3, 0.0F, 1.0F, 0.0F);
        RenderDragon.Api.Rotate(var5, 1.0F, 0.0F, 0.0F);
        RenderDragon.Api.Rotate(var6, 0.0F, 1.0F, 0.0F);
        RenderDragon.Api.Translate(0.0F, -1.2F, 0.0F);
    }
