...
public class ItemRenderer : EntityRenderer
{
    ...
    public void doRenderItem(EntityItem var1, double var2, double var4, double var6, float var8, float var9)
    {
        ...
        RenderDragon.Api.Translate((float)var2, (float)var4 + var11, (float)var6);
        ...
        if (var10.ItemId < 256 && BlockRenderer.IsSideLit(Block.Blocks[var10.ItemId].getRenderType()))
        {
            ...
            RenderDragon.Api.Scale(var28, var28, var28);
            ...
            for (int var29 = 0; var29 < var13; ++var29)
            {
                ...
                if (var29 > 0)
                {
                    ...
                    RenderDragon.Api.Translate(var16, var17, var18);
                }
        ...
        else
        {
            ...
            if (useCustomDisplayColor)
            {
                ...
                RenderDragon.Api.Color4(var24 * var27, var25 * var27, var26 * var27, 1.0F);
            }
    ...
    public void drawItemIntoGui(TextRenderer var1, TextureManager var2, int var3, int var4, int var5, int var6, int var7)
    {
        ...
        if (var3 < 256 && BlockRenderer.IsSideLit(Block.Blocks[var3].getRenderType()))
        {
            ...
            RenderDragon.Api.PushMatrix();
            RenderDragon.Api.Translate(var6 - 2, var7 + 3, -3.0F);
            RenderDragon.Api.Scale(10.0F, 10.0F, 10.0F);
            RenderDragon.Api.Translate(1.0F, 0.5F, 1.0F);
            RenderDragon.Api.Scale(1.0F, 1.0F, -1.0F);
            RenderDragon.Api.Rotate(210.0F, 1.0F, 0.0F, 0.0F);
            ...
            if (useCustomDisplayColor)
            {
                RenderDragon.Api.Color4(var11, var12, var13, 1.0F);
            }
        ...
        else if (var5 >= 0)
        {
            ...
            if (useCustomDisplayColor)
            {
                RenderDragon.Api.Color4(var9, var10, var11, 1.0F);
            }
